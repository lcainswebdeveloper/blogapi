...
Route::middleware('auth:api')->post('/category/{id}/delete', 'CategoryController@destroy');
...
Route::middleware('auth:api')->post('/blog-post/{id}/delete', 'BlogPostController@destroy');
